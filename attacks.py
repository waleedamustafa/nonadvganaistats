...
#   https://github.com/Hadisalman/smoothing-adversarial/blob/master/code/attacks.py
...
from architectures import CNNet4l,ProbCNNet4l
...
class PGD_L2(Attacker):
    ...
    def _attack_mutlinoise_no_grad(self, model: nn.Module, inputs: torch.Tensor, labels: torch.Tensor,
        ...
        for i in range(self.steps):
            ...
            # This model is from https://github.com/mperezortiz/PBB/blob/master/pbb/models.py
            # avoid nan or inf if gradient is 0
            if (grad_norms == 0).any():
